...
class FeatureExtractor():
    ...
    def __init__(self,paths, use_cuda=True, imsize=224, batch_size=32, cuda_device=0, cohort='kid',spatial_avg=True, dataset='rendered_111918'):
        self.paths = paths
    ...
    def extract_feature_matrix(self):
        ...
        def get_metadata_from_path(path,dataset):
            ...
            if self.cohort == 'kid':
                ...
                age = 'unknown'
                session = 'unknown'
            if self.dataset=='photodraw_compiled':
        ...
        if generator:
            while True:    
                ...
                for b in range(batch_size):
                    try:
                        if self.dataset=='photodraw_compiled':
                            sketch, label, age, session, condition = next(generator)
                ...
                categories = ["a drawing of a cat", "a drawing of a bird","a drawing of a rabbit", "a drawing of a house", "a drawing of a chair","a drawing of a bike","a drawing of an airplane","a drawing of a hat","a drawing of a car","a drawing of a watch","a drawing of a cup"," a drawing of a tree"]
