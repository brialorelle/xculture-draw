...
Next, we used these features to train a 12-way logistic classifier with L2 regularization (tolerance = .1, regularization = .1), and used this classifier to predict the category label for each drawing.
...
\textbf{jefan query: Here we describe the training data distribution, but not the test set? What kind of train/test splitting procedure did we use here (LOO? 80/20 CV?)}
