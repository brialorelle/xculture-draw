...
Instead, we found that children across the two sites were indistinguishable with respect to tracing ability on average (Figure \ref{fig:tracing}), although individual tracing scores were strong predictors of the recognizablity of their own drawings, as in prior work [@long2021parallel]. 
...
To follow up on this effect of site, we found that while there was substantial individual variation in tracing ability and effort, these covariates were insufficient to account for differences in drawing recognizability between groups. 
...
While these group-level differences are intriguing, they remain consistent with a number of other potential explanations.
